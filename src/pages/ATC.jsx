    ...
    <MainLayout>
      ...
      >
        ...
        <div className="flex items-center justify-between mb-2 flex-shrink-0">
          <div>
            <p
              className={`text-[10px] tracking-[0.28em] mb-1 ${
        ...
        <div className="grid grid-cols-12 gap-3 flex-1 min-h-0">
          ...
          <div className="col-span-4 min-h-0 flex flex-col">
            <div
              className={`flex-1 min-h-0 ${cardClass} rounded-3xl p-4 flex flex-col`}
            >
              ...
              <div className="flex-1 overflow-y-auto space-y-2 pr-1 min-h-0">
                {communications.map((comm, index) => (
                  <motion.div
                    ...
                    className={`rounded-2xl p-3 ${innerCard}`}
                  >
                    ...
                    <div className="flex gap-2">
                      <button
                        className={`flex-1 py-1.5 rounded-xl text-[10px] font-semibold transition border ${
                          darkMode
                      ...
                      <button className="flex-1 py-1.5 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400 text-[10px] font-semibold hover:bg-red-500/20 transition">
                        DENY
                      </button>
                    </div>
                  </motion.div>
          ...
          <div className="col-span-5 min-h-0 flex flex-col gap-3">
            <div
              className={`flex-1 min-h-0 rounded-3xl p-4 flex flex-col border ${
                darkMode
            ...
            >
              ...
              {/* TERMINAL */}
              <div
                className={`flex-1 min-h-0 rounded-2xl p-4 overflow-y-auto space-y-3 font-mono border ${
                  darkMode
              ...
              <div className="flex gap-3 mt-3 flex-shrink-0">
                <div
                  className={`flex-1 h-10 rounded-2xl border px-4 flex items-center text-xs ${
                    darkMode
                ...
                <button
                  className={`w-10 h-10 rounded-2xl border flex items-center justify-center transition flex-shrink-0 ${
                    darkMode
          ...
          <div className="col-span-3 min-h-0 flex flex-col gap-3">
            {/* RUNWAYS */}
            <div className={`${cardClass} rounded-3xl p-4 flex-shrink-0`}>
              <div className="mb-3">
                <p className="text-zinc-500 text-[10px] tracking-[0.2em] mb-1">
                  RUNWAY OPERATIONS
                </p>
