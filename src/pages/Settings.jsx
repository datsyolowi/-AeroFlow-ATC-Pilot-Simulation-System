...
export default function Settings() {
  ...
  const statItems = [
    { label: "Radar Systems", value: coreStats.radar, color: "#7CFF6B" },
    { label: "Signal Integrity", value: coreStats.signal, color: "#22d3ee" },
    { label: "Server Uptime", value: coreStats.uptime, color: "#7CFF6B" },
